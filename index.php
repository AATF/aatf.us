      ...
      <div class="container marketing">
        ...
        <div class="row featurette">
          ...
          <div class="row featurette">
            ...
            <div class="col-md-3">
              <a href="images/IMG_8945.jpg" alt="preview">
                <img width="250" height="613" class="featurette-image img-responsive" src="images/IMG_8945.jpg" alt="preview">
              </a>
            </div>
            <div class="col-md-3">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/-RCnBZ8N3i8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
          </div>
        </div>
